...
| NFR-Sec-2     | Broker-Credentials nur via IBKR TWS, kein persistenter Save   | P5    | APPROVED |
| NFR-Rel-1     | Daten-Fetch idempotent: wiederholte Aufrufe liefern gleiche Daten | P1 | APPROVED |
| NFR-Rel-2     | Live-Loop uebersteht TWS-Disconnect mit Auto-Reconnect       | P5    | APPROVED |
...
| NFR-Obs-2     | Tageszusammenfassung (P&L, offene Positionen) als Log oder Report | P5 | APPROVED |
...
| NFR-Data-3    | Financial Modelling Prep (FMP) ist Primary Provider, Free-Tier (250 calls/Tag) | P1 | APPROVED |
| NFR-Ops-1     | Lokale Entwicklung + spaeteres Docker-Deployment             | P7    | APPROVED |
